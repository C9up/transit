...
export interface TransitDriver {
	 ...
	 * answer here at all and throws; use {@link TransitDriver.begin}.
	 */
...
export function assertOAuthState(
	...
	if (!expectedState) {
		throw new Error(
			"[transit] OAuth callback requires expectedState for CSRF protection. " +

...
describe("transit > oauth1 > signature base string", () => {
...
describe("transit > oauth1 > percent encoding", () => {
...
describe("transit > oauth1 > signing key", () => {
...
describe("transit > oauth1 > the Authorization header", () => {
...
describe("transit > oauth1 > responses", () => {

...
import { DiscordDriver } from "../../src/drivers/DiscordDriver.js";
import { FacebookDriver } from "../../src/drivers/FacebookDriver.js";
import { GitHubDriver } from "../../src/drivers/GitHubDriver.js";
import { GoogleDriver } from "../../src/drivers/GoogleDriver.js";
import { LinkedInDriver } from "../../src/drivers/LinkedInDriver.js";
import { LinkedInOpenidConnectDriver } from "../../src/drivers/LinkedInOpenidConnectDriver.js";
import { SpotifyDriver } from "../../src/drivers/SpotifyDriver.js";
import { TwitterXDriver } from "../../src/drivers/TwitterXDriver.js";
...
describe("transit > social drivers > where the user is sent", () => {
...
describe("transit > social drivers > PKCE", () => {
...
describe("transit > social drivers > how the client authenticates", () => {
...
describe("transit > social drivers > reading the profile", () => {
...
describe("transit > social drivers > what the provider vouches for", () => {
...
describe("transit > social drivers > GitHub private addresses", () => {
...
describe("transit > social drivers > a token already held", () => {
...
describe("transit > social drivers > begin()", () => {
